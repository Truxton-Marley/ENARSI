...
# AAA
config_server_tacacs = "R1(config-server-tacacs)#"
config_aaa_sg_tacacs = "R1(config-sg-tacacs+)#"
# QoS
config_cmap = "R1(config-cmap)#"
config_pmap = "R1(config-pmap)#"
config_pmap_class = "R1(config-pmap-c)#"
